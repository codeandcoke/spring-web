...
public class ProductController {
    ...
    @PatchMapping(value = "/products/{id}/change-price", produces = "application/json")
    public ResponseEntity<Response> deleteProduct(@PathVariable long id, @RequestBody float price) {
        // TODO Ejemplo de operacion PATCH
        return null;
    }
